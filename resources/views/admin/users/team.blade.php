    ...
    <div class="content-wrapper">
        <div class="page-heading">
            <div>
                ...
                <h1>Team Report: <span>{{ $user->name }}</span></h1>
                <p>Viewing direct downline members and team network for {{ $user->email }}.</p>
            </div>
        </div>
        ...
        <div class="card gold-card users-card detailed-users-card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.users.team', $user->id) }}" id="filter-form">
                    <div class="list-toolbar">
                        <div>
                            <h4 class="card-title mb-1">Downline Members List</h4>
                ...
                <div class="table-responsive table-responsive-scroll mt-3">
                    <table class="table user-table detailed-user-table mb-0" style="min-width: 950px;">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">No downline members found for this user.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
